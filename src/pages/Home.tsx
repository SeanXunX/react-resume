...
const Home = () => (
  <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', height: '100vh', background: '#f0f0f0' }}>
    ...
    <div style={{ display: 'flex', gap: '20px' }}>
      <Link to="/en">
        <button style={{ padding: '15px 30px', fontSize: '16px', cursor: 'pointer' }}>English Resume</button>
      </Link>
      <Link to="/zh">
        <button style={{ padding: '15px 30px', fontSize: '16px', cursor: 'pointer' }}>Chinese Resume</button>
      </Link>
    </div>
  </div>
);
